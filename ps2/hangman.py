...
def get_available_letters(letters_guessed):
    ...
    for char in string.ascii_lowercase:
        if letters_guessed.count(char) == 0:
            left_letters = left_letters + str(char)
    return left_letters
...
#    number_of_warnings = 3
    ...
    while not is_word_guessed(secret_word,guessed_letters) and number_of_guesses_left > 0:
        print("-------------")
        print("You have "+str(number_of_guesses_left)+" left.")
        print("Available letters: "+get_available_letters(guessed_letters))
        user_input = input("Please guess a letter: ")
        user_input = user_input.lower()
        if user_input.isalpha():
            guessed_letters.append(user_input)
            if secret_word.count(user_input) > 0:
            ...
            print("Oops! That is not a valid letter: " +get_guessed_word(secret_word,guessed_letters))
